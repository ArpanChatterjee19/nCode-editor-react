...
function Sidebar() {
  ...
  const [avatarColor, setAvatarColor] = useState("hsl(0,100%,0%)");
    ...
    <div>
      ...
      >
        <nav className="flex flex-1 flex-col items-center space-y-6">
          <NavLink to="/">
            {sidebarOpen ? (
              ...
              <img src={miniLogoImage} alt="ByteScribe" className="h-12 ml-3" />
            )}
          </NavLink>
          <div className="justify-start">
            {
              sidebarOpen ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(255,254,254,1)" onClick={sidebarToggle}><path d="M17 4H3V6H17V4ZM13 11H3V13H13V11ZM17 18H3V20H17V18ZM22.0104 8.81412L20.5962 7.3999L16 11.9961L20.5962 16.5923L22.0104 15.1781L18.8284 11.9961L22.0104 8.81412Z"></path></svg>
              : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(255,255,255,1)" onClick={sidebarToggle}><path d="M17 4H3V6H17V4ZM13 11H3V13H13V11ZM17 18H3V20H17V18ZM15.9896 8.81412L17.4038 7.3999L22 11.9961L17.4038 16.5923L15.9896 15.1781L19.1716 11.9961L15.9896 8.81412Z"></path></svg>
            }
          </div>
          <NavLink
            to="/"
        ...
        <div className="flex flex-col items-center space-y-6">
          <div
            className={`rounded-lg p-1.5 text-gray-50 transition-colors duration-200 hover:bg-gray-800 focus:outline-none flex gap-2 justify-start items-center ${
              sidebarOpen ? "w-44" : ""
            }`}
          >
            <p
